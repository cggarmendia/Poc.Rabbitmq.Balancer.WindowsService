...
namespace Poc.Rabbitmq.Balancer.WindowsService.IntTest.Helpers
{
    /// <summary>
 	...
 	public class Log4netTraceListener : TraceListener
    {
        ...
        #region Variables
        private static readonly ILog _log = LogManager.GetLogger("Poc.Rabbitmq.Balancer.WindowsService.IntTest");
        #endregion
